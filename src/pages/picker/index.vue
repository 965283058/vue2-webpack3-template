...
<template lang="html">
    <div>
        <cells>
            <cell>
                <label slot="icon">日期12212121：</label>
                <DatetimePicker slot="content" v-model="po.date" type="yyyy-MM-dd"></DatetimePicker>
            </cell>
            <cell>
                <label slot="icon">时间11：</label>
                <DatetimePicker slot="content" v-model="po.time" type="hh:mm:ss"></DatetimePicker>
            </cell>
            <cell>
                <label slot="icon">时间日期：</label>
                <DatetimePicker slot="content" v-model="po.datetime" type="yyyy-MM-dd hh:mm:ss"></DatetimePicker>
            </cell>
            <cell>
                <label slot="icon">地区：</label>
                <Picker slot="content" :header="vo.headArr" :selectIndexs="vo.selectIndexs" :changeEventAll="false"
                        :data="vo.area" textField="name" @change="change" @done="selectDone">
                    <input type="text">
                </Picker>
            </cell>
            <div v-html="vo.html" :class="$style.href">  </div>
            <div class="el"></div>
        </cells>
    <div style="margin-top: 50px">
        <Tree :model="vo.treeData" :checkbox="true" @check="treeCheck()"> </Tree>
    </div>
...
<script>
    export default {
        data() {
            return {
                ...
                vo: {
                    ...
                    selectIndexs: [],
                    html:"<a href='http://baidu.com'>a</a>"
                },
                data: {
                    provice: {
                        "44": "广东",
        ...
        mounted: function () {
            this.vo.area.provice = this.data.provice
            setTimeout(()=> {
                this.po.date = "2011-01-22"
                this.po.tiem = '11:33:22'
                this.po.datetime = "2011-01-21 23:23:32"
            }, 5000)
